...
type ScheduleUsecase struct {
	...
	scheduleRepo  *data.ScheduleRepo
...
func (uc *ScheduleUsecase) addJob(ctx context.Context, m *model.ScheduleModel) *errors.Error {
	if ctx.Err() != nil {
...
) (*model.ScheduleModel, *errors.Error) {
	if ctx.Err() != nil {
...
) (int64, *[]model.ScheduleModel, *errors.Error) {
	if ctx.Err() != nil {
