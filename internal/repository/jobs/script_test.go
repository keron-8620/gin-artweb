...
func CreateTestScriptModel(isBuiltin bool) *jobsmodel.ScriptModel {
	return &jobsmodel.ScriptModel{
...
func (suite *ScriptTestSuite) SetupSuite() {
	...
	db.AutoMigrate(&jobsmodel.ScriptModel{})
