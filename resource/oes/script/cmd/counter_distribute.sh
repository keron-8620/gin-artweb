...
OUTPUT_FILE="$JOBS_BASE_DIR/storage/oes/flags/$colony_num/.counter_distribute"
...
./playbook.py --playbook_path collector/counter_distribute/distribute_main.yaml --colony_num $colony_num "$@"
