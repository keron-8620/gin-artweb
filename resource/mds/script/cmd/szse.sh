...
# 定义标志目录路径
flag_rel_path="$dirpath/../../../../storage/mds/flags/$colony_num"
...
./mds_playbook.py --playbook_path collector/szse_gateway/szse_main.yaml --colony_num $colony_num "$@"
