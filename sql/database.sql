...
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('deploy.sh','部署mds集群','$1:集群号名称|字符串|必填|示例:01','mds','dep','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('backup.sh','备份mds集群','$1:集群号名称|字符串|必填|示例:01','mds','dep','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('rollback.sh','回滚mds集群','$1:集群号名称|字符串|必填|示例:01','mds','dep','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('mon.sh','拉取mon上场文件','$1:集群号名称|字符串|必填|示例:01','mds','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('bse.sh','拉取北京产品文件','$1:集群号名称|字符串|必填|示例:01','mds','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('sse.sh','拉取上海产品文件','$1:集群号名称|字符串|必填|示例:01','mds','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('szse.sh','拉取深圳产品文件','$1:集群号名称|字符串|必填|示例:01','mds','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('backup.sh','mds系统日常备份','$1:集群号名称|字符串|必填|示例:01','mds','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('reset.sh','重置mds','$1:集群号名称|字符串|必填|示例:01','mds','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('nakedstart.sh','裸启动mds','$1:集群号名称|字符串|必填|示例:01','mds','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('load.sh','mds加载上场数据','$1:集群号名称|字符串|必填|示例:01','mds','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('start.sh','启动mds','$1:集群号名称|字符串|必填|示例:01','mds','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('stop.sh','停止mds','$1:集群号名称|字符串|必填|示例:01','mds','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('shutoff.sh','关闭mds','$1:集群号名称|字符串|必填|示例:01','mds','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('mds_cleartx_start.sh','mds清除txlog重启','$1:集群号名称|字符串|必填|示例:01','mds','cmd_emgy_mds','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('mds_colony_restart.sh','mds集群拉取上场文件重启','$1:集群号名称|字符串|必填|示例:01','mds','cmd_emgy_mds','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('mds_fixed_start.sh','mds主备切换重启','$1:集群号名称|字符串|必填|示例:01;$2:节点角色|字符串(master/follow/ arbiter)|必填|示例:master','mds','cmd_emgy_mds','shell','1','1','mon');
...
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('rollback.sh','回滚oes集群','$1:集群号名称|字符串|必填|示例:01','oes','dep','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('mon.sh','拉取mon上场文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('counter_fetch.sh','拉取主柜文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('counter_distribute.sh','分发主柜文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('bse.sh','拉取北京产品文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('sse.sh','拉取上海产品文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('szse.sh','拉取深圳产品文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('csdc.sh','拉取中登产品文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('sse_late.sh','拉取上海晚到产品文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('szse_late.sh','拉取深圳晚到产品文件','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('backup.sh','oes系统日常备份','$1:集群号名称|字符串|必填|示例:01','oes','cmd','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('thaw.sh','解冻主柜资金持仓','$1:集群号名称|字符串|必填|示例:01','oes','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('reset.sh','重置oes','$1:集群号名称|字符串|必填|示例:01','oes','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('nakedstart.sh','裸启动oes','$1:集群号名称|字符串|必填|示例:01','oes','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('load.sh','oes加载上场数据','$1:集群号名称|字符串|必填|示例:01','oes','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('open.sh','oes开工','$1:集群号名称|字符串|必填|示例:01','oes','control','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('close.sh','oes收工','$1:集群号名称|字符串|必填|示例:01','oes','control','shell','1','1','mon');
...
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('oes_ezoes_fallback.sh','回滚ezoes','$1:集群号名称|字符串|必填|示例:01','oes','cmd_emgy_oes','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('oes_ezoes_restart.sh','重启ezoes','$1:集群号名称|字符串|必填|示例:01','oes','cmd_emgy_oes','shell','1','1','mon');
...
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('backup.sh','备份mon','$1:节点号|字符串|必填|示例:01','mon','dep','shell','1','1','mon');
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('rollback.sh','回滚mon','$1:节点号|字符串|必填|示例:01','mon','dep','shell','1','1','mon');
