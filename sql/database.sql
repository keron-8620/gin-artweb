...
insert into job_script(name,descr,param_desc,project,label,language,status,is_builtin,username) values('oes_restart.sh','重启oes','$1:集群号名称|字符串|必填|示例:01;$2:是否清除txlog|字符串(ct/nct)|必填|示例:ct','oes','cmd_emgy_oes','shell','1','1','mon');
